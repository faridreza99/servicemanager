    ...
    <DashboardLayout title="Chat">
      <div className="flex flex-col h-[calc(100vh-4rem)]">
        ...
        {isLoading ? (
          ...
          <ChatInterface messages={messages} onSendMessage={handleSendMessage} isOpen={chat.isOpen} isSending={sendMessageMutation.isPending} canSendPrivate canSendQuotation={false} canClose={false} />
        )}
      </div>
    </DashboardLayout>
  );
